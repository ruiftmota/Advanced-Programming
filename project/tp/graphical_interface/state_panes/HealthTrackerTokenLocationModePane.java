...
import tp.logic.state_machine.states.HealthTrackerTokenLocationMode;

public class HealthTrackerTokenLocationModePane extends HBox implements PropertyChangeListener
{
    ...
    private Label label = new Label("How do you want to position the Health Tracker?");

    public HealthTrackerTokenLocationModePane(ObservableGame observable_game)
    {
    ...
    {
        if(observable_game.getState() instanceof HealthTrackerTokenLocationMode == true)
        {
            setVisible(true);
        }
        else
