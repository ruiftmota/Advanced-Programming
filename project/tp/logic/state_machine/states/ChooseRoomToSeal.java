...
public class ChooseRoomToSeal extends GameStateAdapter
{
    public ChooseRoomToSeal(GameData game_data)
    {
        super(game_data);
        return;
    }
    ...
    @Override
    public StateInterface selectRoom(int room)
    {
        GameData game_data = getGameData();
        StateInterface next_state = null;

        game_data.sealRoom(room);
