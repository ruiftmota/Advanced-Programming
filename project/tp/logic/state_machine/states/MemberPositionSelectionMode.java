...
public class MemberPositionSelectionMode extends GameStateAdapter
{
    public MemberPositionSelectionMode(GameData game_data)
    {
        super(game_data);
        return;
    }
    ...
    public StateInterface chooseRandom()
    {
        ...
        game_data.selectMembersPositionRandomly();

        return new HullTrackerTokenLocationMode(getGameData());
    }

    @Override
    public StateInterface chooseManual()
    {
        return new SelectMemberPosition(getGameData());
    }
